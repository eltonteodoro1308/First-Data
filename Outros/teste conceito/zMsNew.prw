...
static function testeGD()
	...
	@ 006, (nJanLarg/2-001)-(0052*02) BUTTON oBtnLege  PROMPT "Legenda"       SIZE 050, 018 OF oDlgPvt ACTION U_TESTE()/*(fLegenda())*/                                  FONT oFontBtn PIXEL
...
user FUNCTION TESTE()
	...
	GDFieldPut( "BM_GRUPO", FWINPUTBOX('DIGITE O VALOR'), oMsGetSBM:nAt, aHeadSBM, aColsSBM )
    oMsGetSBM:LinhaOk(.T.,.T.)

//	oMsGetSBM:aCOLS[ oMsGetSBM:nAt, 2 ]:= FWINPUTBOX('DIGITE O VALOR')
